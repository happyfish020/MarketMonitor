...
from unified_risk.core.cache.auction_cache import has_auction_cache, write_auction_cache
#from unified_risk.core.cache.auction_cache import write_auction_cache
from unified_risk.core.utils.time_utils import now_bj
...
# ============================================================
from unified_risk.core.config import (
...
# ③ 初始化日志系统
# ============================================================
from unified_risk.core.utils.logging_utils import setup_logger
...
from unified_risk.core.modes import (
    run_us_daily_mode,
    run_preopen_mode,
    run_tomorrow_mode,
)
...
# 报告模块（你刚才上传的）
from unified_risk.core.report_writer import (
