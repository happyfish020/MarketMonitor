...
def unify_scores(a_emotion: float, a_short: float, a_mid: float,
                 us_daily: float, us_short: float, us_mid: float) -> UnifiedScore:
    comp = {
        "A_Emotion": a_emotion,
        "A_Short": a_short,
        "A_Mid": a_mid,
    ...
    a_block = (a_emotion + a_short + a_mid) / 60.0 * 60.0
    us_block = (us_daily + us_short + us_mid) / 40.0 * 40.0
